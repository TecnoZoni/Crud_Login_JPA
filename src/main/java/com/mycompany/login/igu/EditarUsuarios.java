...
public class EditarUsuarios extends javax.swing.JFrame {
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(cmbRol, 0, 179, Short.MAX_VALUE))))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(16, 16, 16)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String ususario = txtUsuario.getText();
        String contra = txtContraseña.getText();
        String rol = cmbRol.getSelectedItem().toString();

        control.editarUsuario(us, ususario, contra, rol);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        us = control.traerUsuario(idUsuario);
        txtUsuario.setText(us.getNombre());
        txtContraseña.setText(us.getContrasenia());
        ...
        int cantidadIntems = cmbRol.getItemCount();
        for (int i = 0; i < cantidadIntems; i++) {
